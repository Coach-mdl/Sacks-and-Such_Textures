...
public class HikingBootsModel<T extends LivingEntity> extends HumanoidModel<T> {
	...
	public static LayerDefinition createBodyLayer() {//@formatter:off
		...
		PartDefinition left_foot = left_leg.addOrReplaceChild("left_foot", CubeListBuilder.create().texOffs(17, 0).mirror().addBox(-2.0F, 6.0F, -1.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(1.0F)).mirror(false), PartPose.offset(0.0F, 0.0F, -1.0F));
		...
		PartDefinition right_foot = right_leg.addOrReplaceChild("right_foot", CubeListBuilder.create().texOffs(17, 0).addBox(-2.0F, 6.0F, -1.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(1.0F)), PartPose.offset(0.0F, 0.0F, -1.0F));
